const I18N_EN = {
  ...
  "home.hero.title": "AI-Powered<br>PCB Assembly<br>Inspection Automation",
  ...
  "solution.innovation.1.title": "Instant Inspection, No Teaching Required",
  "solution.innovation.1.copy": "With a deep learning-based inspection system, REX can inspect everything from small samples to mass-produced boards immediately without separate teaching. No highly skilled inspector is required.",
  "solution.innovation.2.title": "High-Speed Inspection Without Delays",
  "solution.innovation.2.copy": "Defects are detected simultaneously through GPU parallel processing. For a 300 mm x 225 mm board, REX performs high-speed inspection in about 20 seconds, minimizing inspection bottlenecks.",
  "solution.innovation.3.title": "Automatic Saving of Inspection Data",
  "solution.innovation.3.copy": "Images of every board are automatically stored. Inspection history and images can be reviewed at any time, enabling objective management of who inspected which board, when it was inspected, and what condition it was in at shipment.",
  "solution.innovation.4.title": "Consistent Inspection Without Skilled Inspectors",
  ...
  "solution.compare.product.size": "Dimensions",
