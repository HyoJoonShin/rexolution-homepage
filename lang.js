const I18N_EN = {
  ...
  "solution.innovation.1.copy": "With a deep learning-based inspection system,<br>REX can inspect from small samples to mass-produced boards immediately.<br>No highly skilled inspector is required.",
  "solution.innovation.2.title": "High-Speed Inspection Without Delays",
  "solution.innovation.2.copy": "Defects are detected simultaneously through GPU parallel processing.<br>For a 300 mm x 225 mm board, REX completes inspection in about 20 seconds.<br>This minimizes inspection bottlenecks.",
  "solution.innovation.3.title": "Automatic Saving of Inspection Data",
  "solution.innovation.3.copy": "Images of every board are automatically stored.<br>Inspection history and images can be reviewed at any time.<br>Shipment condition can be managed with objective data.",
